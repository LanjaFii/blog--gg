...
@WebServlet("/servletImageCouverture")
public class ServletImageCouverture extends HttpServlet {
    private static final long serialVersionUID = 1L;

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String id = request.getParameter("id"); // ID de l'image
        byte[] imageBytes = BlogDAO.getImageById(Integer.parseInt(id)); // Méthode pour récupérer l'image depuis la DB
